...
class TestCarregamentoEProcessamento(unittest.TestCase):
    ...
    def test_executar_etl_comunicacao_sucesso(self, mock_salvar_dataframe_csv, mock_carregar_dados):
        # Dados de teste
    ...
    @patch('src.scripts.Contrato_Agua.index.ProcessamentoDadosDimensaoAgua.carregar_dados', side_effect=Exception("Erro ao carregar dados"))
    @patch('src.scripts.Contrato_Agua.index.ProcessamentoDadosDimensaoAgua.salvar_dataframe_csv')
    def test_executar_etl_comunicacao_erro(self, mock_salvar_dataframe_csv, mock_carregar_dados):
        # Instanciar o objeto de processamento de dados
        processador = ProcessamentoDadosDimensaoAgua('dummy_path.csv')
